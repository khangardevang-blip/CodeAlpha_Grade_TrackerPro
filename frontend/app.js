document.addEventListener('DOMContentLoaded', () => {
    ...
    loginForm.addEventListener('submit', async (e) => {
        ...
        try {
            const res = await fetch('codealphagradetrackerpro-production.up.railway.app/api/auth/login', {
                method: 'POST',
    ...
    registerForm.addEventListener('submit', async (e) => {
        ...
        try {
            const res = await fetch('codealphagradetrackerpro-production.up.railway.app/api/auth/register', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
    ...
    const openDashboard = async (e) => {
        ...
        try {
            const res = await fetch('codealphagradetrackerpro-production.up.railway.app/api/grades/history', {
